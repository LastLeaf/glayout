...
export const texBindRenderingTarget = function(canvasIndex, texId, width, height) {
  ...
  ctx.framebufferTexture2D(ctx.FRAMEBUFFER, ctx.COLOR_ATTACHMENT0, ctx.TEXTURE_2D, texMap[texId], 0)
...
// const texLogPixels = function(canvasIndex, width, height) {
//   const {ctx} = canvases[canvasIndex]
//   const ret = new window.Uint8Array(width * height * 4)
//   ctx.readPixels(0, 0, width, height, ctx.RGBA, ctx.UNSIGNED_BYTE, ret)
//   return ret
// }
