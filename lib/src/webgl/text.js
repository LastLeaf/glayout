...
export const textBindFontFamily = function(id, fontFamily) {
  console.info('textBindFontFamily', id, __glayoutAsm__.UTF8ToString(fontFamily))
...
export const textSetFont = function(fontSize, fontFamilyId, italic, bold) {
  console.info('textSetFont', fontSize, fontFamilyId, italic, bold)
...
export const textDrawInCanvas = function(text, width, height) {
  ...
  ctx.fillStyle = 'black'
  ctx.fillText(__glayoutAsm__.UTF8ToString(text), 0, Math.ceil(height / 2))
}
