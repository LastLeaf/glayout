...
export const textToTex = function(canvasIndex, text, width, height) {
  ...
  ctx.fillStyle = 'black'
  ctx.fillText(__glayoutAsm__.UTF8ToString(text), 0, height / 2 + 1)
  texCreate(canvasIndex, bgCanvas.canvas, -1)
}
