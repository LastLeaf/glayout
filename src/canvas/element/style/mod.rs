...
element_style! {
    ...
    width: f64, Auto(DEFAULT_F64), 0x09, (layout_dirty);
    height: f64, Auto(DEFAULT_F64), 0x0a, (layout_dirty);

    position: PositionType, Absolute(PositionType::Static), 0x10, (layout_dirty);
    left: f64, Auto(DEFAULT_F64), 0x11, (layout_dirty);
    right: f64, Auto(DEFAULT_F64), 0x12, (layout_dirty);
    top: f64, Auto(DEFAULT_F64), 0x13, (layout_dirty);
    bottom: f64, Auto(DEFAULT_F64), 0x14, (layout_dirty);

    flex_basis: f64, Auto(DEFAULT_F64), 0x20, (layout_dirty);
    flex_grow: f32, Absolute(0.), 0x21, (layout_dirty);
    flex_shrink: f32, Absolute(0.), 0x22, (layout_dirty);

    font_family: String, Absolute(String::from("sans-serif")), 0x30, (layout_dirty, inherit);
    font_size: f32, Absolute(16.), 0x31, (layout_dirty, inherit);
    line_height: f32, Auto(DEFAULT_F32), 0x32, (layout_dirty, inherit);
    ...
    margin_left: f64, Absolute(0.), 0x40, (layout_dirty);
    margin_right: f64, Absolute(0.), 0x41, (layout_dirty);
    margin_top: f64, Absolute(0.), 0x42, (layout_dirty);
    margin_bottom: f64, Absolute(0.), 0x43, (layout_dirty);
    padding_left: f64, Absolute(0.), 0x44, (layout_dirty);
    padding_right: f64, Absolute(0.), 0x45, (layout_dirty);
    padding_top: f64, Absolute(0.), 0x46, (layout_dirty);
    padding_bottom: f64, Absolute(0.), 0x47, (layout_dirty);

    border_left_width: f64, Absolute(0.), 0x50, (layout_dirty);
    border_right_width: f64, Absolute(0.), 0x51, (layout_dirty);
    border_top_width: f64, Absolute(0.), 0x52, (layout_dirty);
    border_bottom_width: f64, Absolute(0.), 0x53, (layout_dirty);
